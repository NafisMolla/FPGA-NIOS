 ...
 *
 */
//nios2-terminal | tee /cygdrive/C/users/nmolla/ECE-224/LogicalStep/software/Lab_1/tightpollingData.txt
#include <stdio.h>
#include "system.h"
...
//		    printf("%f, %d, %d, %d, %d, %d \n",latency,multi,missed,i,background_tasks,pulse_width);
		    printf("%d, %d, %d, %f, %d, %d \n",i,pulse_width,background_tasks,latency,missed,multi);

		    //period, pulse width, backround, latency, missed, multi
		}
        //POLLING
        else{
        	//IOWR(STIMULUS_IN_BASE,3,0);
...
//            printf("%f, %d, %d, %d, %d, %d \n",latency,multi,missed,i,count_initial,i/2);
            printf("%d, %d, %d, %f, %d, %d \n",i,i/2,count_initial,latency,missed,multi);
        }
	}
    return 0;
}
