...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../QD1.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x1001148
SOPC_SYSID_FLAG += --sidp=0x1001148
ELF_PATCH_FLAG  += --sidp 0x1001148

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1663183111
SOPC_SYSID_FLAG += --timestamp=1663183111
ELF_PATCH_FLAG  += --timestamp 1663183111
